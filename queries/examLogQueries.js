...
export const getQuestionDetailByExamLogIDAndQuestionIDQuery = `SELECT e.exam_id, e.user_id, e.create_at, e.attempt_at, e.time_taken, e.is_correct as is_answer_correct, q.question_id, s.skill_id, s.skill_name, q.question_text, o.option_id, o.option_text, o.is_correct
FROM examtesting e 
